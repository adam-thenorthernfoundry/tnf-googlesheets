<?php
/**
 * @package The Northern Foundry Google Sheets Integration
 * @version 1.0.0
 */
/*
Plugin Name: The Northern Foundry Google Sheets Integration
...
function g_sheets_plugin_create_menu() {
	...
	add_menu_page('Google Sheets', 'Google Sheets Menu', 'manage_options', 'g_sheets_plugin_settings_page', 'g_sheets_plugin_settings_page');
...
<h1>Google Sheets Importer</h1> <i><a target="_blank" href="http://thenorthernfoundry.com">By The Northern Foundry</a></i>

<p>For reference, heres how to publish a spreadsheet in Google Sheets
<a target="_blank" href="https://support.google.com/docs/answer/37579?hl=en">Publish a spreadsheet</a>
</p>
...
<form method="post" action="options.php">
    ...
    <i>Add the actual column name from your google sheet as it appears (case sensitive)</i>
	 ...
	 <table class="form-table">
		...
		<input style="width:100%;" type="text" name="g_featured_image_path" value="<?php echo esc_attr( get_option('g_featured_image_path') ); ?>" /></td>
        </tr>
        ...
        <b>Simple, just enter the path to your images folder (relative to the root of your site eg. www.yoursite.com/upload_images/)</b></br>
         ...
         <input style="width:100%;" type="text" placeholder="/upload_images/" name="g_featured_image_folder" value="<?php echo esc_attr( get_option('g_featured_image_folder') ); ?>" /></td>
        </tr>
       </table>
 ...
 <hr>
 	...
 	<?php endif; // Only display once spreadshett address is entered ?>
